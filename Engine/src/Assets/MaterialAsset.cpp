...
namespace sa {
	...
	bool MaterialAsset::onLoad(std::ifstream& file, AssetLoadFlags flags) {
	...
	bool MaterialAsset::onWrite(std::ofstream& file, AssetWriteFlags flags) {
		// Values
