...
int main(int, char**)
{
    ...
    */
    ...
    sa::RenderWindow window(1280, 720, "Hello imgui");
    ...
    VkResult err = glfwCreateWindowSurface(g_Instance, window.getWindowHandle(), g_Allocator, &surface);
    check_vk_result(err);

    // Create Framebuffers
    sa::Vector2i extent = window.getCurrentExtent();

    ImGui_ImplVulkanH_Window* wd = &g_MainWindowData;
    SetupVulkanWindow(wd, surface, extent.x, extent.y);
